...
<head>
    ...
    <main class="probootstrap-main">
      <section class="probootstrap-bg probootstrap-animate" data-animate-effect="fadeInLeft" >
          ...
          <h1 class="mb-5">NingXiaCattleBMS</h1>
           <br/><br/>
                    <h3 style="margin-left:200px">具体操作</h3>
      <div class="mb-5"><img src=""  style="position:absolute; left:100px;" alt=""></div>
      <div class="row" style:"float:left" margin-left="800px">
     <div style="width:1500px; margin-left:300px;">
...
<span>http://101.201.238.191:8080/potree/${address}.html</span>
<a href="http://101.201.238.191:8080/potree/${address}.html" target="_blank">点击查看网页</a>
<br /><br />
</div>
<div style="width:1500px; margin-left:300px;">
...
<li>尻宽(一半)：<span>${RW}</span></li>
<li>臀端高：<span>${HH}</span></li>
<li>腰角宽(一半)：<span>${HW}</span></li>
</ol>
</div>
</div>
      </section>
      ...
      <section class="probootstrap-animate mb-5">
        <h1 class="mb-4 text-primary">宁夏肉牛体尺测量</h1>
        <p class="lead">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;宁夏肉牛作为我国地方黄牛的代表性品种，以其肉质细嫩多汁、耐粗饲、抗病力强、适应性广等优点而享誉海内外，被誉为“国之瑰宝”。
                    宁夏肉牛体型是畜牧养殖与育种工作关注的重要内容，在实际生产中体尺评定仍由人工测量完成。宁夏肉牛体型指标繁多，数据获取工作量大。
                    通过本网站后，将完成一整套面向活体宁夏肉牛的3D点云图像采集、预处理、曲面重构、体尺特征分析的过程，可实现活体牛体尺数据的准确测量，
    ...
    <footer class="probootstrap-animate">
      <div><p>
      <p>Copyright &copy; NingXiaCattleBMS.All rights reserved.Design by  <a href="https://cie.nwafu.edu.cn/" title="NWSUAF">CIE_NWSUAF</a></p></div>
